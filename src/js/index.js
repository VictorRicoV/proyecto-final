...
const loadQuestion = index => {
  ...
  options.forEach((option, i) => createOption(option, index, i));
};

const createOption = (option, index, i) => {
  ...
  optionContainer.appendChild(diamondImage);
  ...
  inputElement.addEventListener('change', handleOptionChange);
};
